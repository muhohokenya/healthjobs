    ...
    <AppLayout>
        ...
        >
            <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <h1
                        class="bg-gradient-to-r from-slate-800 to-blue-900 bg-clip-text text-3xl font-bold text-transparent dark:from-slate-200 dark:to-blue-300"
                    >
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div
                        ...
                        :key="profile.id"
                        class="group relative flex flex-col overflow-hidden rounded-2xl border border-white/60 bg-white/70 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/10 dark:border-slate-700/50 dark:bg-slate-800/80"
                    >
                        ...
                        <div class="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 px-6 py-8">
                            ...
                            <div class="flex justify-center">
                                <div class="relative">
                                    ...
                                    <div
                                        v-if="profile.avatar"
                                        class="h-24 w-24 overflow-hidden rounded-full border-4 border-white/90 shadow-xl ring-4 ring-white/20"
                                    >
                                        <img
                                            :src="profile.avatar"
                                        ...
                                        <div
                                            class="hidden h-full w-full items-center justify-center bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-600 text-white"
                                        >
                                    ...
                                    <div
                                        v-else
                                        class="flex h-24 w-24 items-center justify-center rounded-full border-4 border-white/90 bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-600 text-white shadow-xl ring-4 ring-white/20"
                                    >
                                        <span class="text-lg font-bold">{{ getInitials(profile.name) }}</span>
                                    </div>
                        ...
                        <div class="flex-1 p-6">
                            ...
                            <div v-else class="mb-4">
                                <p class="text-sm text-slate-500 italic dark:text-slate-500">Professional profile description not available.</p>
                            </div>

                            <!-- License Information -->
                            <div
                                v-if="profile.licence_number"
                                class="mb-4 rounded-xl border border-slate-100 bg-gradient-to-br from-slate-50 to-blue-50/50 p-3 dark:border-slate-600/50 dark:from-slate-700/50 dark:to-slate-800/50"
                            >
                        ...
                        <!-- Footer Section -->
                        <div
                            class="border-t border-slate-100/80 bg-gradient-to-r from-slate-50/50 to-blue-50/30 p-6 pt-4 dark:border-slate-700/50 dark:from-slate-800/50 dark:to-slate-700/50"
                        >
                            <div class="flex items-center justify-between">
                                <!-- View Profile Button -->
                                <Link
                                    :href="`/profiles/${profile.id}`"
                                    class="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-4 py-2.5 text-sm font-semibold text-white transition-all duration-200 hover:scale-105 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 hover:shadow-lg focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                                >
                                ...
                                <!-- Contact Button -->
                                <button
                                    class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white/80 px-4 py-2.5 text-sm font-semibold text-slate-700 backdrop-blur-sm transition-all duration-200 hover:scale-105 hover:border-blue-300 hover:bg-blue-50/80 hover:text-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-slate-600 dark:bg-slate-800/80 dark:text-slate-300 dark:hover:border-blue-500 dark:hover:bg-slate-700/80 dark:hover:text-blue-400"
                                >
                ...
                <div v-if="!props.profiles || props.profiles.length === 0" class="py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">No medical professionals have registered yet.</p>
                </div>
            </div>
        </div>
    </AppLayout>
