            ...
            <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                        ...
                        <div class="relative bg-gradient-to-br from-gray-600 via-gray-400 to-gray-400 px-6 py-8">
                        ...
                        >
                            ...
                            <div class="mt-4 text-center text-white">
                                ...
                                <p class="text-gray-300 drop-shadow-sm">{{ formatProfession(profile.profession || 'Healthcare Provider') }}</p>
                            </div>
                        </div>
...
<!--                                <h4 class="mb-2 text-sm font-semibold text-slate-800 dark:text-slate-200">About:</h4>-->
                                ...
                                <div class="text-slate-500 dark:text-slate-500" v-html="profile.description"></div>
                            </div>
