...
<template>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-3">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center shadow-lg bg-gradient-to-br from-emerald-600 via-red-600 to-black">
                    ...
                    <span class="font-extrabold text-xl bg-gradient-to-r from-emerald-700 via-red-600 to-black bg-clip-text text-transparent">
            MediCareers Kenya
          </span>
                </div>

                <div class="hidden md:flex items-center space-x-8">
                    <a href="#" class="text-gray-700 hover:text-emerald-700 transition-colors font-medium">Jobs</a>
                    <a href="#" class="text-gray-700 hover:text-emerald-700 transition-colors font-medium">Hospitals</a>
                    <a href="#" class="text-gray-700 hover:text-emerald-700 transition-colors font-medium">About</a>
                    <a href="#" class="text-gray-700 hover:text-emerald-700 transition-colors font-medium">Contact</a>
                </div>

                <div class="flex items-center space-x-4">
                    <button @click="navigateToLogin" class="hidden md:block text-gray-700 hover:text-emerald-700 transition-colors font-medium">
                        Login
                    </button>
                    <button
                        @click="navigateToRegister"
                        class="bg-gradient-to-r from-emerald-600 to-green-700 text-white px-6 py-2.5 rounded-full hover:shadow-lg transform hover:scale-105 transition-all duration-200 font-medium"
                    >
                        Get Started
                    </button>
    ...
    <!-- Hero Section -->
    <section class="relative pt-24 pb-28 bg-gradient-to-br from-emerald-50 via-white to-green-50 overflow-hidden">
        <!-- Decorative circles in Kenyan palette -->
        <div class="absolute top-24 left-10 w-16 h-16 bg-emerald-200/40 rounded-full"></div>
        <div class="absolute top-32 right-20 w-14 h-14 bg-red-200/40 rounded-full"></div>
        <div class="absolute bottom-40 left-20 w-12 h-12 bg-black/10 rounded-full"></div>

        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
                <!-- Left Content -->
                <div class="space-y-8">
                    <div class="inline-flex items-center px-4 py-2 bg-emerald-100 rounded-full text-emerald-800 text-sm font-medium">
              ...
              Medical Jobs in Kenya
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button
                            @click="navigateToRegister"
                            class="bg-gradient-to-r from-emerald-600 to-green-700 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2"
                        >
                        ...
                        <a
                            href="#jobs"
                            class="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-full text-lg font-semibold hover:border-emerald-600 hover:text-emerald-700 transition-all duration-300 flex items-center justify-center space-x-2"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4">
                        <div class="rounded-xl border border-gray-200 bg-white px-3 py-2 text-xs text-gray-600">
                ...
                <!-- Right Content - Hero Images (Kenyan imagery) -->
                <div class="relative">
...
<!--                                src="https://images.unsplash.com/photo-1576765608264-7efc7c2e1b9f?q=80&w=1200&auto=format&fit=crop"-->
                        ...
                        <!-- Floating card: hire event -->
                        <div class="absolute -top-6 -left-6 bg-white rounded-xl p-4 shadow-lg">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 bg-emerald-50 rounded-full grid place-items-center">
                        ...
                        <!-- Floating card: Kenyan clinician -->
                        <div class="absolute -bottom-4 -right-4 bg-white rounded-xl p-4 shadow-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                />
                                <div>
                                    <div class="text-sm font-semibold text-gray-900">Dr. Wanjiru</div>
    ...
    <section class="relative bg-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                <div
                    class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-100 to-red-100 rounded-full text-emerald-800 text-sm font-medium mb-6"
                >
    ...
    <section id="jobs" class="py-24 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    ...
                    <div class="relative p-6 pb-4">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1 pr-4">
                                <h3 class="text-xl font-bold leading-tight text-gray-900 group-hover:text-emerald-700 mb-2">
                                    Registered Nurse – ICU
                                </h3>
                                <div class="flex items-center space-x-2 mb-2">
                                    <span class="text-sm text-gray-500">[Sign up to view facility]</span>
                                </div>
                            </div>
                            <span
                                class="inline-flex items-center rounded-full bg-emerald-50 px-3 py-1.5 text-xs font-semibold text-emerald-700 ring-1 ring-emerald-200/50"
                            >
                Full-time
              </span>
                        </div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-50">
                                <svg class="h-4 w-4 text-emerald-700" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        fill-rule="evenodd"
                    ...
                    <div class="flex-1 px-6">
                        ...
                        <div class="mt-4 rounded-lg border border-emerald-100 bg-emerald-50/40 p-4">
                            <h4 class="mb-2 flex items-center text-sm font-semibold text-emerald-800">
                                <svg class="mr-2 h-4 w-4 text-emerald-700" viewBox="0 0 20 20" fill="currentColor">
                                    <path
                                        fill-rule="evenodd"
                    ...
                    <div class="mt-auto border-t border-gray-50 p-6 pt-4">
                        <div class="flex items-center justify-between">
                            <div class="space-y-1">
                                <div class="text-sm font-semibold text-gray-600">KES •••• – ••••</div>
                                <div class="text-xs text-gray-500">Senior Level</div>
                            </div>
                            <button
                                @click="navigateToRegister"
                                class="inline-flex items-center space-x-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg hover:bg-emerald-700"
                            >
                ...
                >
                    <div class="relative p-6 pb-4">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1 pr-4">
                                <h3 class="text-xl font-bold leading-tight text-gray-900 group-hover:text-red-700 mb-2">
                                    Pediatrician
                                </h3>
                                <div class="text-sm text-gray-500">Mombasa</div>
                            </div>
                ...
                Full-time
                        ...
                        <div class="px-6 pt-4">
                            <div class="rounded-lg border border-red-100 bg-red-50/40 p-4">
                                <h4 class="mb-2 text-sm font-semibold text-red-800">Key Requirements</h4>
                                <ul class="space-y-2">
                    ...
                    <div class="mt-auto border-t border-gray-50 p-6 pt-4">
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                @click="navigateToRegister"
                                class="inline-flex items-center space-x-2 rounded-xl bg-red-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg hover:bg-red-700"
                            >
                                <span>Unlock Details</span>
                            </button>
                        </div>
                ...
                <!-- Sample Job 3 -->
                <div
                    class="group relative flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-black/20"
                >
                    <div class="relative p-6 pb-4">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1 pr-4">
                                <h3 class="text-xl font-bold leading-tight text-gray-900 group-hover:text-gray-900 mb-2">
                                    Medical Laboratory Technologist
                                </h3>
                                <div class="text-sm text-gray-500">Kisumu</div>
                            </div>
                            <span class="inline-flex items-center rounded-full bg-gray-100 px-3 py-1.5 text-xs font-semibold text-gray-800">
                Contract
              </span>
                        </div>
                        <p class="px-6 text-sm text-gray-600">
                        ...
                        <div class="px-6 pt-4">
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                                <h4 class="mb-2 text-sm font-semibold text-gray-800">Key Requirements</h4>
                                <ul class="space-y-2">
                    ...
                    <div class="mt-auto border-t border-gray-50 p-6 pt-4">
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                @click="navigateToRegister"
                                class="inline-flex items-center space-x-2 rounded-xl bg-gray-900 px-5 py-2.5 text-sm font-semibold text-white shadow-lg hover:bg-black"
                            >
                                <span>Unlock Details</span>
                            </button>
                        </div>
            ...
            <div class="text-center">
                ...
                <div class="space-y-4">
                    <button
                        @click="navigateToRegister"
                        class="bg-gradient-to-r from-emerald-600 to-green-700 text-white px-10 py-4 rounded-full text-lg font-semibold hover:shadow-2xl transform hover:scale-105 transition-all duration-300 mr-4"
                    >
                        View All Roles
                    </button>
    ...
    <!-- Features Section (Kenyan-centric copy) -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div
                    ...
                    :key="feature.title"
                    class="bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-xl hover:border-emerald-200 transition-all duration-300"
                >
    ...
    <!-- Final CTA -->
    <section class="py-24 bg-gradient-to-r from-emerald-700 via-red-600 to-black relative overflow-hidden">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button
                    @click="navigateToRegister"
                    class="bg-white text-emerald-700 px-10 py-4 rounded-full text-lg font-bold hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center space-x-2"
                >
            ...
            <!-- Legal note -->
            <p class="mt-6 text-xs text-emerald-100/80">
